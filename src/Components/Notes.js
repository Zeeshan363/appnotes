...
const Notes = (props) => {
  ...
  return (
    <>
      <div className="sm:w-[80%] mx-auto sm:flex sm:justify-between sm:flex-wrap lg:w-[85%]">
        <div className="h-[180px] w-[80%] mx-auto shadow-lg shadow-gray-400 border-2 my-10 relative sm:w-[45%] lg:w-[30%] xl:w-[23%">
